	...
	grunt.initConfig(
		{
			...
			uglify: {
				...
				common: {
					files: {
						'js/common.js': [
							'js/src/libs/jquery.js', 'js/src/libs/jquery-fn.js', 'js/src/libs/localstorage.js', 'js/src/libs/jquery.autoComplete.js',
			...
			watch: {
				...
				common: {
					files: ['js/src/libs/jquery.js', 'js/src/libs/jquery-fn.js', 'js/src/libs/localstorage.js', 'js/src/libs/jquery.autoComplete.js',
						'js/src/libs/modal.js', 'js/src/tools/router.js',
						'js/src/libs/underscore.js', 'js/src/libs/utils.js',
						'js/src/tools/navigate.js',
						'js/src/tools/notification.js',
